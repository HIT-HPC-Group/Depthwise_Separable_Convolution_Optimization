...
# ===================================================================================================
# Define Hyperparameters for training. https://github.com/chenhang98/mobileNet-v2_cifar10
batch_size = 16
# EPOCHS = 160
EPOCHS = 3
...
resultTable = pd.DataFrame(
        np.insert(resultTable.values, len(resultTable.index), values=[result[0], result[1]], axis = 0), columns = columns)
...
resultTable.to_csv("V100S_MobileNetV2_Result.csv")